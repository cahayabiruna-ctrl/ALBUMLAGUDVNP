document.addEventListener('DOMContentLoaded', () => {
    ...
    showLyricsBtn.addEventListener('click', () => {
        ...
        lyricsContent.innerText = songToShow.lyrics; // <-- Mengisi Lirik
